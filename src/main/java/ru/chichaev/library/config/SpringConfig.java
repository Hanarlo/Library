package ru.chichaev.library.config;
...
@Configuration
@ComponentScan("ru.chichaev.library")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableJpaRepositories("ru.chichaev.library.repositories")
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        em.setPackagesToScan("ru.chichaev.library.models");
